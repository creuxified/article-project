<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center min-h-screen lg:py-0" style="justify-content: flex-start; padding-top: 200px;">
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img class="w-8 h-8 mr-2" src="http://127.0.0.1:8000/images/logo_UNS.png" alt="logo">
            UNS Citation Management
        </a>
        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                @if (session()->has('error'))
                    <div
                        class="flex p-4 mb-4 text-sm text-red-800 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800"
                        role="alert">
                        <svg aria-hidden="true" class="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-4H9V7h2v2z"></path>
                        ...
                        <button type="button"
                            class="ml-2 inline-flex items-center justify-center w-4 h-4 text-red-500 hover:bg-red-200 rounded-full focus:outline-none"
                            wire:click="$set('error', null)" aria-label="Close">
                            <svg class="w-2 h-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                    clip-rule="evenodd"></path>
                ...
                <form class="space-y-4 md:space-y-6" wire:submit="login">
                    <div>
                        ...
                        <input type="email" name="email" id="email"
                            class="@error('email') is-invalid @enderror border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
